...
public class SWDatabase : MonoBehaviour
{
    ...
    {
        "Home", "Time", "Untitled", "Stay", "Forever", "Angel", "Lost", "Alone", "You", "Hold On", "Rain", "Goodbye", "Heaven", "Tonight", "Fire", "Falling", "Shine", "Paradise", "Forever", "I Love You", "Butterfly", "Blue", "Call Me", "I Want You", "Love Me", "One", "Crazy", "Friends", "Hallelujah", "Smile", "Without You", "Happy", "Runaway", "Cherish", "Lady", "My Love", "Sober", "Closer", "Numb", "Leave", "Free", "Let Me Love You", "Sorry", "Hurt", "Cold", "Stronger", "Deja Vu", "Monster", "Beautiful", "Meant To Be", "Flying", "Stars", "Haunted", "Nightmare", "Days", "Dreams", "Secrets", "Heartbeat", "Gold", "Silver", "Breathe", "Baby", "Perfect", "Ghost", "Crash", "Witchcraft", "Blood", "It's Over", "The End", "Stand Up", "Red", "Invincible", "Borderline", "So What", "Eyes", "Broken", "Lucky", "Jealous", "Tears", "Prayers", "Flowers", "Wait", "Electric", "Changes", "Flashback", "Gamble", "Lightning", "Addicted", "High", "My Life", "Money", "Tomorrow", "Home", "Midnight"
    };
    ...
    public void OpenUser(in string username)
    {
        ...
        {
            userProfile.RandomUser(username, FindAllFriends(username));
        }
    ...
    public void LoadHistory(in SWHistory.GameState backState)
    {
        ...
        else if (backState.window == SWHistory.Window.User)
        {
            ...
            else userProfile.RandomUser(backState.username, FindAllFriends(backState.username));
        }
    ...
    public List<string> FindAllFriends(in string username)
    {
    ...
    public static string GetRandomTrackName()
    {
        return GENERIC_TRACKS[Random.Range(0, GENERIC_TRACKS.Count)];
    }

    // Context Menu
    [ContextMenu("Random Username")]
    public void Editor_GetRandomUsername()
    {
        Debug.Log(ALL_USERS[Random.Range(0, ALL_USERS.Count)]);
    }
}
