...
namespace TMPro.EditorUtilities
{
    ...
    [CustomEditor(typeof(InputFieldNoScroll), true)]
    public class InputFieldNoScrollEditor : SelectableEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_foldout.fontSettings)
            {
                ...
                {
                    InputFieldNoScroll inputField = target as InputFieldNoScroll;
                ...
                if (!m_ContentType.hasMultipleDifferentValues)
                {
                    ...
                    if (m_ContentType.enumValueIndex == (int)InputFieldNoScroll.ContentType.Standard ||
                        m_ContentType.enumValueIndex == (int)InputFieldNoScroll.ContentType.Autocorrected ||
                        m_ContentType.enumValueIndex == (int)InputFieldNoScroll.ContentType.Custom)
                    {
                        EditorGUI.BeginChangeCheck();
                        ...
                        if (EditorGUI.EndChangeCheck())
                        {
                            if (text != null)
                            {
                                if (m_LineType.enumValueIndex == (int)InputFieldNoScroll.LineType.SingleLine)
                    ...
                    if (m_ContentType.enumValueIndex == (int)InputFieldNoScroll.ContentType.Custom)
                    {
                        ...
                        if (m_CharacterValidation.enumValueIndex == (int)InputFieldNoScroll.CharacterValidation.Regex)
                        {
                            EditorGUILayout.PropertyField(m_RegexValue);
                        }
                        else if (m_CharacterValidation.enumValueIndex == (int)InputFieldNoScroll.CharacterValidation.CustomValidator)
                        {
